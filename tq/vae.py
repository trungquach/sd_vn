...
class VariationalAutoencoder(object):
    ...
    def _create_network(self):
        ...
        n_z = self.network_architecture(network_weights["n_z"])
    ...
    def _initialize_network(self, n_hidden_recog_1, n_hidden_recog_2, n_hidden_gener_1, n_hidden_gener_2,n_input,n_z):
        all_weights = dict()
    ...
    def _recognition_network(self, weights, biases):
        ...
        layer_1 = self.tranfer_fct(tf.add(tf.matmul(self.z, weights['h1']), biases['h1']))
        layer_2 = self.tranfer_fct(tf.add(tf.matmul(layer_1, weights['h2']), biases['h2']))
    ...
    def _create_loss_optimize(self):
        ...
        reconstr_loss = - tf.reduce_mean(self.x * tf.log(1e-10 + self.x_reconstr_mean) +
