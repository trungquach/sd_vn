...
def train(vae,mini_batchs,test_data,test_label,save_out_model,n_epoch=150):
    lr_decay = 0.97
    lr_freq = 200
    eval_freq = 100
    n_count = 0
...
if __name__ == '__main__':
    ...
    _, threshold = train(vae=vae, mini_batchs=mini_batchs,test_data=test_norm_datas,test_label=test_labels,save_out_model=save_out_model) #1
    #train(vae=vae, mini_batchs=mini_batchs, test_data=norm_datas, test_label=labels,save_out_model=save_out_model) #2
